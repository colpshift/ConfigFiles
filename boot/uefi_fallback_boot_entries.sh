...
set -euo pipefail
#
# File: uefi_fallback_boot_entry.sh
# Author: Colps
...
efibootmgr -d /dev/sda -p 1 -c -L "Arch Fallback" -l /efi/EFI/arch/vmlinuz-linux -u 'root=PARTUUID=16ac66ce-37f6-4947-9a7b-fe298fb12136 rw initrd=\efi\EFI\arch\intel-ucode.img initrd=efi\EFI\arch\initramfs-linux-fallback.img' -v
