...
### path
typeset -U path
path=($HOME/.local/bin $HOME/.local/share/gem/ruby/2.7.0/bin $HOME/.scripts $HOME/.rbenv/bin $HOME/.cargo/bin $HOME/.config/nvcode/utils/bin $GEM_HOME/bin /bin /usr/bin /sbin /usr/sbin /usr/local/bin $path[@])
